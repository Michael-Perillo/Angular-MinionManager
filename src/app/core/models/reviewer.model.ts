...
export const REVIEWERS: Reviewer[] = [
  ...
  },
  {
    ...
    modifierPool: ['starting-gold-zero', 'board-limited', 'gold-halved', 'lock-mayhem', 'automation-disabled'],
    yearMinimum: 2,
    goldTarget: 300,
  },
  {
    ...
    modifierPool: ['no-hiring', 'upgrades-disabled', 'board-frozen', 'gold-drain', 'automation-disabled'],
    yearMinimum: 2,
    goldTarget: 350,
  },
];
